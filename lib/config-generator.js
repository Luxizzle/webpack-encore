...
const swcLoaderUtil = require('./loaders/swc');
...
class ConfigGenerator {
    ...
    buildRulesConfig() {
        ...
        let rules = [
            this.webpackConfig.useSWCLoader ?
                applyRuleConfigurationCallback('javascript', {
                    test: swcLoaderUtil.getTest(this.webpackConfig),
                    exclude: this.webpackConfig.babelOptions.exclude,
                    use: swcLoaderUtil.getLoaders(this.webpackConfig)
                }) :
                applyRuleConfigurationCallback('javascript', {
        ...
        if (this.webpackConfig.useTypeScriptLoader && !this.webpackConfig.useSWCLoader) {
